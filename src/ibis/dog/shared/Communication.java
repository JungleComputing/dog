...
public class Communication implements MessageUpcall, ReceivePortConnectUpcall {
    ...
    public Communication(String name, Upcall upcall)
        ...
        System.out.println("####### starting ibis 3");

        System.out.println("PROP:" + System.getProperties());

        Properties properties = new Properties();
        properties.put("ibis.verbose", "true");
        properties.put("ibis.implementation", "tcp");
        properties.put("ibis.starters", "ibis.ipl.impl.tcp.TcpIbisStarter");
        properties.put("ibis.registry.implementation", "central");
