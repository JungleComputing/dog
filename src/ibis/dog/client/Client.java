...
public class Client implements VideoConsumer, RegistryEventHandler {
    ...
    private synchronized FeatureVector getFeatureVector(long timestamp) throws Exception {
        ...
        if (newestVector == null) {
            throw new Exception("Error while learning object: cannot get vector");
        }
        
        return newestVector;
    }

    public void learn(String name, ProgressListener listener) throws Exception {
    ...
    public RecognizeResult recognize(ProgressListener listener) throws Exception {
