...
// TODO: REACT TO FAILURE PROPERLY
        ...
        case Request.OPERATION_RECOGNISE: {    
			...
			CxWeibull.doRecognize(img.width,
								  img.height, img.pixels, v.vector);
            reply = v;
            break;
        }
...
//		}   
        ...
        if (master) {
            ...
            try { 
                comm.send(r.replyAddress,
					Communication.CLIENT_REPLY_REQUEST, new Reply(me,
							r.sequenceNumber, r.operation, reply));
            } catch (Exception e) {
